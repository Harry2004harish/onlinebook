...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `featuredproduct`(name, price, image,product_desc,author) VALUES('$name', '$price', '$image','$product_desc','$author')") or die('query failed');
