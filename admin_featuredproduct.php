...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image,product_desc,author,type,genres) VALUES('$name', '$price', '$image','$product_desc','$author','featureproduct','$genres')") or die('query failed');
