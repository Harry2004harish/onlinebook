    ...
    <section class="products">
        ...
        <div class="box-container">
            ...
            <?php  
              ...
              $offset=($page-1)*$limit;
         $select_products = mysqli_query($conn, "SELECT * FROM `products` where type='featureproduct'ORDER BY id DESC LIMIT {$offset},{$limit}") or die('query failed');
      ...
      ?>
        ...
        <?php
        $select_products = mysqli_query($conn, "SELECT COUNT(*) FROM `products` where type='featureproduct' ") or die('query failed');
